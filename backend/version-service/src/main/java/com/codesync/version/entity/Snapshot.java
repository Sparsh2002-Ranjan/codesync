...
public class Snapshot {
    ...
    @Column(name = "content", columnDefinition = "LONGTEXT", nullable = false) private String content;
    @Column(name = "hash", nullable = false, length = 64) private String hash;
    @Column(name = "parent_snapshot_id") private String parentSnapshotId;
    @Column(name = "branch", nullable = false, length = 100) private String branch = "main";
    @Column(name = "tag", length = 50) private String tag;
