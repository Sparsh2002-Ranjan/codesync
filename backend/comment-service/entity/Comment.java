...
public class Comment {
    ...
    @Column(name = "comment_id", updatable = false, nullable = false) private String commentId;
    ...
    @Column(name = "column_number") private int columnNumber;
    @Column(name = "parent_comment_id") private String parentCommentId;
